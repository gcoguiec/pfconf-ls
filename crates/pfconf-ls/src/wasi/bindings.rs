...
#[doc(hidden)]
pub(crate) use __export_world_pfconf_ls_cabi;
#[repr(align(4))]
...
mod _rt {
    ...
    pub use alloc_crate::{alloc, string::String};
...
macro_rules! __export_pfconf_ls_impl {
  ($ty:ident) => (self::export!($ty with_types_in self););
  ($ty:ident with_types_in $($path_to_types_root:tt)*) => (
  $($path_to_types_root)*::__export_world_pfconf_ls_cabi!($ty with_types_in $($path_to_types_root)*);
  )
}
#[doc(inline)]
pub(crate) use __export_pfconf_ls_impl as export;
